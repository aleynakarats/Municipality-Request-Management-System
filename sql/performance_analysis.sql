...
--Yürütme planı, orta büyüklükteki sonuç kümeleri için Bitmap Heap Scan kullanır.
...
--Bileşik indeks, PostgreSQL optimizasyon algoritması tarafından seçilir.
...
--Kısmi endeksleme, tahmini işlem maliyetini düşürür.
